...
EXPR_FILE_2="${OUTPUT_DIRECTORY}/experiments_big.csv"

RESULT_FILE="${OUTPUT_DIRECTORY}/experiments_results.csv"
RESULT_FILE_2="${OUTPUT_DIRECTORY}/experiments_big_results.csv"
...
# generate the DoE
Rscript ./scripts/gen_experiments.R $EXPR_FILE $EXPR_FILE_2
...
# analyze the results
Rscript ./scripts/analysis.R $RESULT_FILE $RESULT_FILE_2 $OUTPUT_DIRECTORY $NB_THREADS
